...
class HomeController extends Controller
{
    ...
    public function trainings($id){
        ...
        if(Auth::user()->role_id == "Student"){
            ...
            $paid = DB::table('program_user')->where('program_id', $program->id)->value('t_amount');
            $balance = DB::table('program_user')->where('program_id', $program->id)->value('balance');
