                ...
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($transaction->program->p_name); ?> <br>(<?php echo e($transaction->program->e_amount <= 0 ? 'Amount: '.\App\Models\Settings::select('DEFAULT_CURRENCY')->first()->value('DEFAULT_CURRENCY').$transaction->program->p_amount : 'E/Amount '. \App\Models\Settings::select('DEFAULT_CURRENCY')->first()->value('DEFAULT_CURRENCY').$transaction->program->e_amount); ?>) <br>
                            <?php if(!is_null($transaction->coupon_code)): ?>
                                <span style="color:blue">
                                    <strong>Coupon (<?php echo e($transaction->coupon); ?>) Applied | <?php echo e(\App\Models\Settings::select('DEFAULT_CURRENCY')->first()->value('DEFAULT_CURRENCY').number_format($transaction->coupon->coupon_amount)); ?>  </strong>
                                </span>
                                <?php endif; ?>
                            </td>
