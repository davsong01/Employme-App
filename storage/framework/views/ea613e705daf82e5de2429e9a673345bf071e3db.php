                            ...
                            <div class="row">  
                                <div class="col-md-4" style="margin-bottom:5px">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="auto_certificate_template" value="<?php echo e(old('auto_certificate_template')); ?>" class="form-control" >
                                    </div>
                                    <?php endif; ?>
                                    <div class="form-group">
                                        <label>Certificate name color</label>
                                        <input type="color" class="form-control" name="auto_certificate_color" value="<?php echo e($certificate_settings['auto_certificate_color'] ??  old('auto_certificate_color')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4" style="margin-bottom:5px">
                                    <div class="form-group">
                                        <label>Certificate name font size</label>
                                        <input type="number" min="0" class="form-control" name="auto_certificate_name_font_size" value="<?php echo e($certificate_settings['auto_certificate_name_font_size'] ?? old('auto_certificate_name_font_size')); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Certificate name font weight</label>
                                        <input type="number" min="0" class="form-control" name="auto_certificate_name_font_weight" value="<?php echo e($certificate_settings['auto_certificate_name_font_weight'] ?? old('auto_certificate_name_font_weight')); ?>">
                                    </div>
                                ...
                                <div class="col-md-4" style="margin-bottom:5px">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" class="form-control" name="auto_certificate_top_offset" value="<?php echo e($certificate_settings['auto_certificate_top_offset'] ?? old('auto_certificate_top_offset')); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Certificate Left offset</label>
                                        <input type="number" min="0" class="form-control" name="auto_certificate_left_offset" value="<?php echo e($certificate_settings['auto_certificate_left_offset'] ?? old('auto_certificate_left_offset')); ?>">
