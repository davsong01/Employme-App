            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large" src="<?php echo e('/' . $training->image); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                                    ...
                                    <?php if (isset($modes) && count($modes) > 0) : ?>
                                        <div class="checkout__input">
                                            ...
                                            <select name="modes" id="payment_modes" required>
                                                ...
                                                <?php $__currentLoopData = $modes;
                                                $__env->addLoop($__currentLoopData);
                                                foreach ($__currentLoopData as $mode => $value) : $__env->incrementLoopIndices();
                                        ...
                                        <?php if (isset($locations) && count($locations) > 0) : ?>
                                            <div class="checkout__input" id="locations_div" style="display:none">
                                                ...
                                                <select name="location" id="locations" required>
                                                    ...
                                                    <?php $__currentLoopData = $locations;
                                                    $__env->addLoop($__currentLoopData);
                                                    foreach ($__currentLoopData as $location => $value) : $__env->incrementLoopIndices();
                                                        $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if (isset($training->allow_preferred_timing) && $training->allow_preferred_timing == 'yes') : ?>
                                            <div class="checkout__input">
                                                ...
                                                <select name="preferred_timing" id="preferred_timing" required>
                                                    <option value="">Select...</option>
                                                    <?php $__currentLoopData = $training->programRange();
                                                    $__env->addLoop($__currentLoopData);
                                                    foreach ($__currentLoopData as $preferred_timing) : $__env->incrementLoopIndices();
                                                        $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if ($training->p_amount > 0) : ?>
                                            <div class="checkout__input">
                                                ...
                                                <select name="type" id="" required>
                                                    <option value="">Select</option>
                                                    <option value="full" <?php echo e(old('amount') == $training->p_amount ? 'selected' : ''); ?>>Full Payment (<?php echo e($currency_symbol . number_format($training->p_amount)); ?>)</option>
                                                    <?php if (($training->e_amount > 0) && $training->close_earlybird == 0 || $training->e_amount > 0) : ?>
