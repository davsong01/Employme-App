                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control" name="name" id="name" placeholder="Enter Name" value="<?php echo e(request('name')); ?>">
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong>Name: </strong><a href="<?php echo e(route('users.edit', $transaction->user_id)); ?>" target="_blank"><?php echo e($transaction->user->name ?? 'N/A'); ?> &nbsp;<img src="/external.png" alt="" style="width: 10px;"></a>
                                    <br> <strong>Phone: </strong><?php echo e($transaction->user->t_phone ?? 'N/A'); ?> <br> <strong>Email:</strong> <?php echo e($transaction->user->email ?? 'N/A'); ?>

                                    <?php if($transaction->user->last_login): ?> <br>
                                    <span style="color:green"><strong>Last Login: </strong><?php echo e($transaction->user->last_login ? date("M jS, Y H:i", strtotime($transaction->user->last_login)) : ''); ?></span>
                                    <?php endif; ?>
                                    <br> 
                                    <strong>Account balance: </strong><?php echo e(number_format($transaction->user->account_balance)); ?></td>
                                <td>
