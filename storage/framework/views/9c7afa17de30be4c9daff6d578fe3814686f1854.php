                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>Name: </strong><a href="<?php echo e(route('users.edit', $transaction->user_id)); ?>" target="_blank"><?php echo e($transaction->user->name ?? 'N/A'); ?> &nbsp;<img src="/external.png" alt="" style="width: 10px;"></a>
                                    <br> <strong>Phone: </strong><?php echo e($transaction->t_phone ?? 'N/A'); ?> <br> <strong>Email:</strong> <?php echo e($transaction->user->email ?? 'N/A'); ?> <br> <strong>Account balance: </strong><?php echo e(number_format($transaction->user->account_balance)); ?></td>
                                <td>
