            ...
            <div class="">
                <table id="transTable" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($transaction->name ?? 'N/A'); ?> <br><?php echo e($transaction->t_phone ?? 'N/A'); ?> <br> <?php echo e($transaction->email ?? 'N/A'); ?> </td>
                            <td>
                                <small class="training-details">
                                    <strong>Training:</strong> <?php echo e($transaction->p_name ?? 'N/A'); ?> <br>  
                             ...
                             <td>
                                <div class="btn-group">
                                    <a data-toggle="tooltip" data-placement="top" title="Edit Transaction"
                                        class="btn btn-info" href="<?php echo e(route('payments.edit', $transaction->id)); ?>"><i
                                            class="fa fa-edit"></i>
                                    </a>
                                    <a data-toggle="tooltip" data-placement="top" title="Print E-receipt"
                                        class="btn btn-warning" href="<?php echo e(route('payments.print', $transaction->id)); ?>"><i
                                            class="fa fa-print"></i>
                                    </a>
                                    <a data-toggle="tooltip" data-placement="top" title="Send E-receipt"
                                        class="btn btn-primary" href="<?php echo e(route('payments.show', $transaction->id)); ?>"><i
