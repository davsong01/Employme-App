        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('teachers.update', $user->id)); ?>" method="POST" enctype="multipart/form-data" class="pb-2">
                        ...
                        <div class="row" style="margin-top:20px">
                                ...
                                <?php if (!empty(array_intersect(facilitatorRoles(), $user->role()))) : ?>
                                    <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                                        ...
                                        <select name="payment_mode" id="payment_mode" class="form-control" required>
                                            ...
                                            <?php $__currentLoopData = $payment_modes;
                                            $__env->addLoop($__currentLoopData);
                                            foreach ($__currentLoopData as $mode) : $__env->incrementLoopIndices();
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                    ...
                                    <input id="password" type="text" class="form-control" name="password" value="<?php echo e(old('password') ?? ''); ?>" autofocus>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="training[]" id="training" class="select2 form-control m-t-15" multiple="multiple" style="height: 30px;width: 100%;">
                                        <?php $__currentLoopData = $allprograms;
                                        $__env->addLoop($__currentLoopData);
                                        foreach ($__currentLoopData as $allprogram) : $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row" style="margin-bottom: 10px">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = app('app\Http\Controllers\Controller')->adminMenus();
                                    $__env->addLoop($__currentLoopData);
