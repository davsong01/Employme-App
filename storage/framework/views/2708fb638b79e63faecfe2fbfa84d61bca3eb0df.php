                ...
                <div class="card-body">
                    <div class="card-title">
                        ...
                        <h4 class="card-title"><?php echo e($user->name); ?></h4>
                         <?php if($user->role_id == 'Facilitator'): ?>  
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="role" id="class" class="form-control">
                                        ...
                                        <option value="Facilitator" <?php echo e($user->role_id == 'Facilitator' ? 'selected' : ''); ?>>Facilitator</option>
                                        <option value="Grader" <?php echo e($user->role_id == 'Grader' ? 'selected' : ''); ?>>Grader</option>
