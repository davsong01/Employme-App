            ...
            <div class="">
                <table id="zero_config" class="">
                    ...
                    <tbody>
                         ...
                         <?php if($programs->questions_count >0): ?>
                            <tr>
                                <td><?php echo e($i++); ?></td>
                                <td><a data-toggle="tooltip" data-placement="top" title="Click to view questions for this training"
                                    class="btn btn-info" href="<?php echo e(route( 'questions.show', $programs->id )); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/employme/resources/views/dashboard/admin/questions/index.blade.php ENDPATH**/ ?>