        ...
        <div class="col-md-6 col-lg-6">
            <div class="card">
                <div class="box bg-dark text-center">
                    ...
                    <p class="text-white"><?php echo e(\App\Models\Settings::value('DEFAULT_CURRENCY'). number_format($account_balance)); ?> &nbsp;&nbsp; <a class="btn btn-success" style="color:white" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> &nbsp;Top Up Now</a></p>
                </div>
            </div>
        </div>
    </div>
