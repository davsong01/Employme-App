            ...
            <div lass="card-title">
                ...
                <div class="card-header">
                    <div>
                        ...
                        <div class="mt-4">
                            <form class="row" method="GET" action="<?php echo e(route('users.index')); ?>">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color:green"><?php echo e($user->last_login ? date("M jS, Y H:i", strtotime($user->last_login)) : ''); ?></td>
                            <td>
