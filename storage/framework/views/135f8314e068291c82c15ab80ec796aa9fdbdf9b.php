                            ...
                            <div class="row">  
                                ...
                                <div class="col-md-4" style="margin-bottom:5px">
                                    <div class="form-group">
                                        ...
                                        <select name="auto_certificate_status" class="form-control" id="hasmock" required>
                                            <option value="yes" <?php echo e(old('auto_certificate_status') == 1 ? 'selected' : ''); ?>>Yes</option>
                                            <option value="no" <?php echo e(old('auto_certificate_status') == 0 ? 'selected' : ''); ?>>No</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4" style="margin-bottom:5px">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" class="form-control" required name="certificate_top_offset">
                                       
                                    </div>
                                    <div class="form-group">
                                        <label>Certificate Top offset</label>
                                        <input type="number" min="0" required class="form-control" name="certificate_top_offset">
