...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-header">
                <div>
                    <h5 class="card-title"> All Modules <?php if(auth()->user()->role_id == "Admin" || in_array(21, $menus)): ?><a href="<?php echo e(route('modules.create', ['p_id' => $program_name->id] )); ?>"><button type="button" class="btn btn-outline-primary">Add New Module </button></a><?php endif; ?> </h5> 
                </div>
            </div>
            <div class="">
                <table id="zero_config" class="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-info btn-sm" href="<?php echo e(route('modules.edit', $module->id)); ?>" onclick="return confirm('Are you really sure?');"><i
                                            class="fa fa-edit"></i> Edit
                                    </a>
                                    <?php if($module->status == 0): ?>
                                    <a class="btn btn-primary btn-sm" href="<?php echo e(route('modules.enable', $module->id)); ?>" onclick="return confirm('Are you really sure?');"><i
                                            class="fa fa-check"></i> Enable
                                    </a>
                                    <?php else: ?>
                                    <a class="btn btn-info btn-sm" href="<?php echo e(route('modules.disable', $module->id)); ?>" ><i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/employme/resources/views/dashboard/teacher/modules/show.blade.php ENDPATH**/ ?>