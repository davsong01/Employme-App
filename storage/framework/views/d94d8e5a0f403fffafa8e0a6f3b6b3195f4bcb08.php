                ...
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="margin: auto;display: flex;border-bottom: none;"><button class="disabled btn btn-<?php echo e($user->role_id == 'Facilitator' ? 'primary' : 'info'); ?> btn-sm"><?php echo e($user->role_id); ?></button> <br>
