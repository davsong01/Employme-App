              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>CRM Test Score* <span style="color:green">(Max score =
                      <?php echo e($program->scoresettings->crm_test); ?>)</span></label>
                  <input type="number" name="crm_score"
                    value="<?php echo e(old('crm_score') ?? $details['crm_test_score']); ?>" class="form-control" min="0"
                    max="<?php echo e($program->scoresettings->crm_test); ?>" required>
                </div>
                <div><small style="color:red"><?php echo e($errors->first('crm_score')); ?></small></div>
                </div>
                <?php endif; ?>
              <?php endif; ?>
