                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly value="<?php echo e($program->name); ?>" placeholder= "<?php echo e($program->p_name); ?>" class="form-control" required
                                    <div><small style="color:red"><?php echo e($errors->first('program')); ?></small></div>
                                    <input type="hidden" id="program" name="program_id" value="<?php echo e($program->id); ?>" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php else: ?>
                                    <select name="type" id="class" class="form-control" required readonly>
                                        <option value="<?php echo e($module->type == 'Class Test' ? 0 : 1); ?>"><?php echo e($module->type); ?></option>
                                    </select>
                                <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="allow_test_retake" class="form-control" id="allow_test_retake" required>
                                    <option value="1" <?php echo e($program->allow_test_retake == 1 ? 'selected' : ''); ?>>Yes</option>
                                    <option value="0" <?php echo e($program->allow_test_retake == 0 ? 'selected' : ''); ?>>No</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('dashboard.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/employme/resources/views/dashboard/admin/modules/edit.blade.php ENDPATH**/ ?>