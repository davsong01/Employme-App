                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                ...
                                <div class="col-md-12" style="display: flex;">
                                    <div class="form-group col-md-4" style="float: left;">
                                        <img src="<?php echo e(asset(\App\Settings::value('favicon'))); ?>" alt="favicon" style="width: 64px;"/>
                                    </div>
                                ...
                                <div class="form-group col-md-12" style="display: flex;">
                                    <div class="form-group col-md-4" style="float: left;">
                                        <img src="<?php echo e(asset(\App\Settings::value('logo'))); ?>" alt="logo" style="width: 170px;" >
                                    </div>
                                ...
                                <div class="form-group col-md-12" style="display: flex;">
                                    <div class="form-group col-md-4" style="float: left;">
                                        <img src="<?php echo e(asset(\App\Settings::value('banner'))); ?>" alt="banner" style="width: 95px">
                                    </div>
                                    <div class="form-group col-md-8" style="float: right;">
