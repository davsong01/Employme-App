...
<div>
    <p style="text-align:justify !important">Your balance payment of {{ $data['currency_symbol'] }}{{ $data['amount'] }} for {{ $data['programName'] }} has been received.<br><br>You can now access all sections of your portal!
    </p>
</div>
@else 
<div>   
    <span style="text-align:justify !important">Your {{ $data['message'] }} of {{  $currency_symbol.$data['amount'] }} for the {{ $data['programName'] }} ({{ $data['programAbbr'] }}) via {{ $data['t_type'] }} has been received. <br><br>
    </span>
    <span>
    ...
    <a href="{{ config('app.url') }}/login">Login to your Portal here</a>
