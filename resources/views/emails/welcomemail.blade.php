...
<div>
    <p style="text-align:justify !important">Your balance payment of {{ \App\Settings::select('DEFAULT_CURRENCY')->first()->value('DEFAULT_CURRENCY'). $data['amount'] }} for {{ $data['programName'] }} has been received.<br><br>
