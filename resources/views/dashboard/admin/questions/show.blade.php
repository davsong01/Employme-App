        ...
        <div class="card-body">
            <div class="card-header" style="color:#008000; text-align:center; padding:20px">
                <h2>{{ strtoupper($p_name) }}</h2> <h3 style="text-align:center; padding:20px"> QUESTION MANAGEMENT</h3><br>
                 <a href="{{route('questions.add', ['p_id'=> $p_id])}}"><button style="align:left" type="button" class="btn btn-outline-primary" >Add New question</button></a></h5><br> <br>
                    <a href = "{{ route('questions.import', ['p_id' => $p_id]) }}" class="btn btn-custon-four btn-success"><i class="fa fa-upload"></i> Import Questions</a>
            </div>
        </div>
    </div>
     <div class="card">
