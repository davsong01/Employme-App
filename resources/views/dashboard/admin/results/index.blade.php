                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if(auth()->user()->role_id == 'Admin')<br><strong class="tit">Class Tests:</strong> {{ $user->final_ct_score }}% <br> @endif
                                @if(auth()->user()->role_id == 'Admin' || auth()->user()->role_id == 'Facilitator')<strong class="tit">Role Play: </strong> {{ $user->total_role_play_score }}%  <br> @endif
                                @if(auth()->user()->role_id == 'Admin' || auth()->user()->role_id == 'Grader')<strong>Email: </strong> {{ $user->total_email_test_score }}% @endif
