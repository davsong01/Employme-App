                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    <input id="phone" type="text" class="form-control" name="t_phone"
                                        value="{{ old('t_phone') ?? $user->t_phone }}" autofocus required>
                                    @if ($errors->has('phone'))
                                    <span class="help-block">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="role_id" type="text" class="form-control" name="role_id"
                                        value="{{ $user->role_id }}" autofocus disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gender" id="class" class="form-control">
                                        ...
                                        <option value="0" {{ $user->gender == 'Female' ? 'selected' : ''}}>Female
                                        </option>
