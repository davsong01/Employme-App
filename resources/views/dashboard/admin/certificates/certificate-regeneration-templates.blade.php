            ...
            <table id="zero_config" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a data-bs-toggle="modal" data-bs-target="#edit-{{ $template->id }}" class="btn btn-light" title="Edit template">
...
$(document).ready(function() {
    ...
    $('#previewButton').on('click', function(e) {
            ...
            $('#certificateRows .added-row').each(function() {
                var row = $(this);
                formData.append('text_type[]', row.find('select[name="text_type[]"]').val());
                formData.append('text_type_face[]', row.find('select[name="text_type_face[]"]').val());
                formData.append('auto_certificate_name_font_size[]', row.find('input[name="auto_certificate_name_font_size[]"]').val());
                formData.append('auto_certificate_name_font_weight[]', row.find('input[name="auto_certificate_name_font_weight[]"]').val());
                formData.append('auto_certificate_top_offset[]', row.find('input[name="auto_certificate_top_offset[]"]').val());
                formData.append('auto_certificate_left_offset[]', row.find('input[name="auto_certificate_left_offset[]"]').val());
                formData.append('auto_certificate_color[]', row.find('input[name="auto_certificate_color[]"]').val());
            });
