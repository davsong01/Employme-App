        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @if($scoreSetting->module_status_count <= 0)
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="update_previous_score" type="checkbox" name="update_previous_score">
                            <label class="form-check-label" for="update_previous_score">
                                Update Previously Computed Scores (WIP)
                            </label>
                        </div>
                    </div>
                    @endif
