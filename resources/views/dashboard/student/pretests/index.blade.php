                ...
                <div class="card" style="background-color: #eeeeee; margin-bottom:5px">
                    <div class="box bg-white text-center"
                        ...
                        @if($module->completed == 0)
                            <a href="{{route('participants.mocks.show', ['mock' => $module->id, 'p_id' => $program->id])}}"><button style="width:100%" type="button" class="btn btn-outline-info" onclick="return confirm('I have read the instructions above?');">Start Now!</button></a>
                        @endif
