    ...
    <div class="scroll-sidebar">
            ...
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse  first-level" style="margin-left:30px">                    
                        <li class="sidebar-item"><a href="{{route('users.index')}}" class="sidebar-link"><span class="hide-menu">- View your students </span></a>
                        </li>
                    </ul>
                </li>
        ...
        <!---end of class management links-->
            ...
            <ul style="margin-left:30px" aria-expanded="false" class="collapse  first-level">
                ...
                <li class="sidebar-item"><a href="{{route('materials.create')}}" class="sidebar-link"><span class="hide-menu">- Add study materials </span></a>
                </li>
                <li class="sidebar-item"><a href="{{route('materials.index')}}" class="sidebar-link"><span class="hide-menu">- View study materials </span></a>
                </li>
            </ul>
        </li>
        <!---end of class management links-->
